...
class EfficientNetLightning(pl.LightningModule):
    def __init__(self, num_classes=2, learning_rate=1e-3):
        super(EfficientNetLightning, self).__init__()
        self.save_hyperparameters()

        # Modelo EfficientNet-B0 pré-treinado (você pode escolher outras versões como EfficientNet-B1, B2, etc.)
        self.model = models.efficientnet_b0(pretrained=True)

        # Modificar a camada final para ter 1 saída (binária)
