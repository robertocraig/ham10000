...
class SkinDataset(Dataset):
    def __init__(self, csv_file, img_dir, transform=None,  include_numerical_features=True, numerical_columns=None):
        """
        ...
        # Armazenar numerical_columns
        if self.include_numerical_features:
            if numerical_columns is None:
                raise ValueError("numerical_columns must be provided when include_numerical_features is True.")
